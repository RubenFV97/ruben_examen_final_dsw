...
class Transition extends Model
{
    protected $fillable = [
        ...
        'loop_count',
        'is_initial',
        'trigger_config', // Asegúrate de incluir trigger_config en los fillables
    ];
    ...
    protected $casts = [
        ...
        'is_initial' => 'boolean',
        'trigger_config' => 'array', // Asegúrate de castear trigger_config como array
    ];
    ...
    {
        return $this->belongsTo(DesaButton::class, 'desa_buttons_id');
    }
    ...
    public function setTriggerConfig($data)
    {
        switch ($this->trigger) {
            ...
            case 'user_choice':
                ...
                $this->desa_button_id = $data['desa_button_id'] ?? null;
                $this->loop_count = null;
                break;
            case 'loop':
                $this->time_seconds = null;
